export default class Pedido {
  ...
  sucessoAoPagar() {
    ...
    if (this.estadoAtual === Pedido.AGUARDANDO_PAGAMENTO) {
      ...
      console.log('The order is not waiting for payment');
    }
  }
  ...
  cancelarPedido() {
    ...
    if (this.estadoAtual === Pedido.AGUARDANDO_PAGAMENTO) {
      ...
      console.log('The order cannot be cancelled'); // Senão mostre uma mensagem de erro;
    }
  }
  ...
  despacharPedido() {
    ...
    if (this.estadoAtual === Pedido.PAGO) {
      ...
      console.log('The order is cancelled'); // Senão mostre uma mensagem de erro;
    }
  }
}
